...
export class PDFExportService {
  ...
  private createCoverPage(project: Project): void {
    ...
    this.doc.text('Multi-Language Project Analysis', this.margin + 50, this.currentY);
    ...
    this.doc.setTextColor(100, 100, 100);
    this.doc.text('Copyright © Zensar Technologies Ltd.', this.pageWidth / 2, this.pageHeight - 30, { align: 'center' });
